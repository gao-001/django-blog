# Generated by Django 2.2.16 on 2020-10-06 14:31
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_nav', models.IntegerField(default=False, verbose_name='是否为导航')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.PositiveIntegerField(choices=[(1, '正常'), (0, '删除'), (2, '草稿')], default=1, verbose_name='状态码')),
                ('created_time', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
